@extends('layouts.app')
@section('title', 'Relacionar Recibos')
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Lista de Recibos Pendientes por Relación
                            ...
                            <div class="table-responsive">
                                <table id="table" class="table table-striped table-hover dataTable js-exportable" width="100%">
                                    ...
                                    @foreach($recibos as $item)
                                        <tr>
                                            <td>
                                                <input type="checkbox" id="md_checkbox_25" class="filled-in chk-col-indigo" checked="" value="{{ $item->id }}">
                                                <label for="md_checkbox_25">{{ $item->id }}</label>
                                            </td>
