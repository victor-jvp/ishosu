@extends('layouts.app')
@section('title', 'Modificar Recibo '.$recibo->idZero)
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control monto" id="monto_doc_usd" readonly
                                                name="monto_doc_usd" value="0">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control monto" id="total_grav" readonly
                                                value="0">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" id="fields_transferencia">
                                <div class="col-sm-4">
                                    <select class="form-control show-tick dropup " data-live-search="true"
                                        data-container="body" data-size="10" data-title="Banco Emisor" id="banco_e">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control show-tick dropup" data-live-search="true"
                                        data-container="body" data-size="10" data-title="Banco Receptor" id="banco_r">
...
<script>
    ...
    function UpdateMontos() {
        ...
        let monto_factura
        if ($("#tipo_moneda _usd").prop("checked")) {
