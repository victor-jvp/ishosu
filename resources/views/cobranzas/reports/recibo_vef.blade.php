...
<table class="table-bordered" style="width: 100%;">
    ...
    <tr>
        <td class="text-center" rowspan="2" colspan="2" style="width: 150px; font-size: 11pt; font-weight: bold">
            {{ $recibo->idZero }}</td>
    ...
    <tr>
        <td colspan="3"></td>
        <td class="text-right" style="padding: 5px;">FACTURA Nº:</td>
    ...
    <tr>
        <td colspan="4">
            <table class="table-bordered" style="width: 100%">
                ...
                $total = $valCantidad * $valDenominacion;
                $sumTotal += $total;
                @endphp
                ...
                <tr>
                    ...
                    <td class="text-center" style="font-size: 9pt; font-weight: bold">{{ number_format($sumTotal, 2) }}
                    </td>
                </tr>
            </table>
        </td>
